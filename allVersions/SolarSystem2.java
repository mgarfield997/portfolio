...
public class SolarSystem2 extends JFrame implements GLEventListener, KeyListener
{
	private static final long serialVersionUID = 1L;
	private GLCanvas myCanvas;
	private int rendering_program1, rendering_program2, rendering_programTex, rendering_programLight;
	...
	//Skybox variables
	private String[] vLightShaderSource, fLightShaderSource;
	...
	private Point3D lightLoc = new Point3D(0.0f, 10.0f, 3.0f);
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		int mv_loc = gl.glGetUniformLocation(rendering_programLight, "mv_matrix");
		int proj_loc = gl.glGetUniformLocation(rendering_programLight, "proj_matrix");
		int n_loc = gl.glGetUniformLocation(rendering_programLight, "norm_matrix");
		...
		mv_loc = gl.glGetUniformLocation(rendering_programTex, "mv_matrix");
		proj_loc = gl.glGetUniformLocation(rendering_programTex, "proj_matrix");
		n_loc = gl.glGetUniformLocation(rendering_programTex, "norm_matrix");
	...
	public static void main(String[] args) { new SolarSystem2(); }
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		fBlinn1ShaderSource = util.readShaderSource("Shadow/blinnFrag1.shader");
		fBlinn2ShaderSource = util.readShaderSource("Shadow/blinnFrag2.shader");
		vLightShaderSource = util.readShaderSource("ShaderSolarSystem/vert.shader");
		fLightShaderSource = util.readShaderSource("ShaderSolarSystem/frag.shader");
		importVShaderSource = util.readShaderSource("ShaderSolarSystem/vert2.shader");
		importFShaderSource = util.readShaderSource("ShaderSolarSystem/frag2.shader");
		...
		gl.glShaderSource(vShader1, vBlinn1ShaderSource.length, vBlinn1ShaderSource, null, 0);
		gl.glShaderSource(vShader2, vBlinn2ShaderSource.length, vBlinn2ShaderSource, null, 0);
		gl.glShaderSource(fShader1, fBlinn1ShaderSource.length, fBlinn1ShaderSource, null, 0);
		gl.glShaderSource(fShader2, fBlinn2ShaderSource.length, fBlinn2ShaderSource, null, 0);
		...
		gl.glAttachShader(rendering_programTex, importvShader);
		gl.glAttachShader(rendering_programTex, importfShader);
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		int globalAmbLoc = gl.glGetUniformLocation(rendering_program1, "globalAmbient");
		gl.glProgramUniform4fv(rendering_program1, globalAmbLoc, 1, globalAmbient, 0);
	
		// get the locations of the light and material fields in the shader
		int ambLoc = gl.glGetUniformLocation(rendering_program1, "light.ambient");
		int diffLoc = gl.glGetUniformLocation(rendering_program1, "light.diffuse");
		int specLoc = gl.glGetUniformLocation(rendering_program1, "light.specular");
		int posLoc = gl.glGetUniformLocation(rendering_program1, "light.position");
		int MambLoc = gl.glGetUniformLocation(rendering_program1, "material.ambient");
		int MdiffLoc = gl.glGetUniformLocation(rendering_program1, "material.diffuse");
		int MspecLoc = gl.glGetUniformLocation(rendering_program1, "material.specular");
		int MshiLoc = gl.glGetUniformLocation(rendering_program1, "material.shininess");
	
		//  set the uniform light and material values in the shader
		gl.glProgramUniform4fv(rendering_program1, ambLoc, 1, currentLight.getAmbient(), 0);
		gl.glProgramUniform4fv(rendering_program1, diffLoc, 1, currentLight.getDiffuse(), 0);
		gl.glProgramUniform4fv(rendering_program1, specLoc, 1, currentLight.getSpecular(), 0);
		gl.glProgramUniform3fv(rendering_program1, posLoc, 1, viewspaceLightPos, 0);
		gl.glProgramUniform4fv(rendering_program1, MambLoc, 1, currentMaterial.getAmbient(), 0);
		gl.glProgramUniform4fv(rendering_program1, MdiffLoc, 1, currentMaterial.getDiffuse(), 0);
		gl.glProgramUniform4fv(rendering_program1, MspecLoc, 1, currentMaterial.getSpecular(), 0);
		gl.glProgramUniform1f(rendering_program1, MshiLoc, currentMaterial.getShininess());
	}
